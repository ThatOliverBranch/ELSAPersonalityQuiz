...
tiebreaker4D = () => {
    ...
    //four way tie
    else if ( (score4D == scoreBR) && (score4D == scoreDV) && (score4D == scoreML) && (score4D != (scoreSP || scorePP)) ) {
    ...
    } else if ( (score4D == scoreBR) && (score4D == scoreDV) && (score4D == scoreSP) && (score4D != (scoreML || scorePP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (score4D == scoreBR) && (score4D == scoreDV) && (score4D == scorePP) && (score4D != (scoreML || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (score4D == scoreBR) && (score4D == scoreML) && (score4D == scoreSP) && (score4D != (scoreDV || scorePP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (score4D == scoreBR) && (score4D == scoreML) && (score4D == scorePP) && (score4D != (scoreDV || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (score4D == scoreBR) && (score4D == scoreSP) && (score4D == scorePP) && (score4D != (scoreDV || scoreML)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (score4D == scoreDV) && (score4D == scoreML) && (score4D == scoreSP) && (score4D != (scoreBR || scorePP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (score4D == scoreDV) && (score4D == scoreML) && (score4D == scorePP) && (score4D != (scoreBR || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (score4D == scoreDV) && (score4D == scoreSP) && (score4D == scorePP) && (score4D != (scoreBR || scoreML)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (score4D == scoreML) && (score4D == scoreSP) && (score4D == scorePP) && (score4D != (scoreBR || scoreDV)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
...
tiebreakerBR = () => {
    //two way tie
    if ( (scoreBR == score4D) && (scoreBR != (scoreDV || scoreML || scoreSP || scorePP)) ) {
        let i =  Math.floor(Math.random() * 2 );
        if ( i < 1 || i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else {
    ...
    //three way tie
    else if ( (scoreBR == score4D) && (scoreBR == scoreDV) && (scoreBR != (scoreML || scoreSP || scorePP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreBR == score4D) && (scoreBR == scoreML) && (scoreBR != (scoreDV || scoreSP || scorePP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreBR == score4D) && (scoreBR == scoreSP) && (scoreBR != (scoreDV || scoreML || scorePP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreBR == score4D) && (scoreBR == scorePP) && (scoreBR != (scoreDV || scoreML || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    //four way tie
    else if ( (scoreBR == score4D) && (scoreBR == scoreDV) && (scoreBR == scoreML) && (scoreBR != (scoreSP || scorePP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreBR == score4D) && (scoreBR == scoreDV) && (scoreBR == scoreSP) && (scoreBR != (scoreML || scorePP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreBR == score4D) && (scoreBR == scoreDV) && (scoreBR == scorePP) && (scoreBR != (scoreML || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreBR == score4D) && (scoreBR == scoreML) && (scoreBR == scoreSP) && (scoreBR != (scoreDV || scorePP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreBR == score4D) && (scoreBR == scoreML) && (scoreBR == scorePP) && (scoreBR != (scoreDV || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreBR == score4D) && (scoreBR == scoreSP) && (scoreBR == scorePP) && (scoreBR != (scoreDV || scoreML)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreBR == scoreDV) && (scoreBR == scoreML) && (scoreBR == scoreSP) && (scoreBR != (score4D || scorePP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreBR == scoreDV) && (scoreBR == scoreML) && (scoreBR == scorePP) && (scoreBR != (score4D || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreBR == scoreDV) && (scoreBR == scoreSP) && (scoreBR == scorePP) && (scoreBR != (score4D || scoreML)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreBR == scoreML) && (scoreBR == scoreSP) && (scoreBR == scorePP) && (scoreBR != (score4D || scoreDV)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    //five way tie
    else if ( (scoreBR == score4D) && (scoreBR == scoreDV) && (scoreBR == scoreML) && (scoreBR == scoreSP) && (score4D != scorePP) ) {
        let i =  Math.floor(Math.random() * 5 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreBR == score4D) && (scoreBR == scoreDV) && (scoreBR == scoreML) && (scoreBR == scorePP) && (score4D != scoreSP) ) {
        let i =  Math.floor(Math.random() * 5 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreBR == score4D) && (scoreBR == scoreML) && (scoreBR == scoreSP) && (scoreBR == scorePP) && (scoreBR != scoreDV) ) {
        let i =  Math.floor(Math.random() * 5 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
...
tiebreakerDV = () => {
    //two way tie
    if ((scoreDV == score4D) && (scoreDV != (scoreBR || scoreML || scoreSP || scorePP)) ) {
        let i =  Math.floor(Math.random() * 2 );
        if ( i < 1 || i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else {
    ...
    } else if ( (scoreDV == scoreBR) && (scoreDV != (score4D || scoreML || scoreSP || scorePP)) ) {
        let i =  Math.floor(Math.random() * 2 );
        if ( i < 1 || i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else {
    ...
    //three way tie
    else if ( (scoreDV == scoreBR) && (scoreDV == score4D) && (scoreDV != (scoreML || scoreSP || scorePP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreDV == score4D) && (scoreDV == scoreML) && (scoreDV != (scoreBR || scoreSP || scorePP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreDV == score4D) && (scoreDV == scoreSP) && (score4D != (scoreBR || scoreML || scorePP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreDV == score4D) && (scoreDV == scorePP) && (scoreDV != (scoreBR || scoreML || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreDV == scoreBR) && (scoreDV == scoreML) && (scoreDV != (score4D || scoreSP || scorePP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreDV == scoreBR) && (scoreDV == scoreSP) && (scoreDV != (score4D || scoreML || scorePP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreDV == scoreBR) && (scoreDV == scorePP) && (scoreDV != (score4D || scoreML || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    //four way tie
    else if ( (scoreDV == scoreBR) && (scoreDV == score4D) && (scoreDV == scoreML) && (scoreDV != (scoreSP || scorePP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreDV == scoreBR) && (scoreDV == score4D) && (scoreDV == scoreSP) && (scoreDV != (scoreML || scorePP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreDV == scoreBR) && (scoreDV == score4D) && (scoreDV == scorePP) && (scoreDV != (scoreML || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreDV == score4D) && (scoreDV == scoreML) && (scoreDV == scoreSP) && (scoreDV != (scoreBR || scorePP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreDV == score4D) && (scoreDV == scoreML) && (scoreDV == scorePP) && (scoreDV != (scoreBR || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreDV == score4D) && (scoreDV == scoreSP) && (scoreDV == scorePP) && (scoreDV != (scoreBR || scoreML)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreDV == scoreBR) && (scoreDV == scoreML) && (scoreDV == scoreSP) && (scoreDV != (score4D || scorePP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreDV == scoreBR) && (scoreDV == scoreML) && (scoreDV == scorePP) && (scoreDV != (score4D || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreDV == scoreBR) && (scoreDV == scoreSP) && (scoreDV == scorePP) && (scoreDV != (score4D || scoreML)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreDV == scoreML) && (scoreDV == scoreSP) && (scoreDV == scorePP) && (scoreDV != (score4D || scoreBR)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/daVinky.html");
        } else if ( i == 1 ) {
    ...
    //five way tie
    else if ( (scoreDV == scoreBR) && (scoreDV == score4D) && (scoreDV == scoreML) && (scoreDV == scoreSP) && (scoreDV != scorePP) ) {
        let i =  Math.floor(Math.random() * 5 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreDV == scoreBR) && (scoreDV == score4D) && (scoreDV == scoreML) && (scoreDV == scorePP) && (scoreDV != scoreSP) ) {
        let i =  Math.floor(Math.random() * 5 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreDV == scoreBR) && (scoreDV == score4D) && (scoreDV == scoreSP) && (scoreDV == scorePP) && (scoreDV != scoreML) ) {
        let i =  Math.floor(Math.random() * 5 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreDV == score4D) && (scoreDV == scoreML) && (scoreDV == scoreSP) && (scoreDV == scorePP) && (scoreDV != scoreBR) ) {
        let i =  Math.floor(Math.random() * 5 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreDV == scoreBR) && (scoreDV == scoreML) && (scoreDV == scoreSP) && (scoreDV == scorePP) && (scoreDV != score4D) ) {
        let i =  Math.floor(Math.random() * 5 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
...
tiebreakerML = () => {
    //two way tie
    if ((scoreML == score4D) && (scoreML != (scoreBR || scoreDV || scoreSP || scorePP)) ) {
        let i =  Math.floor(Math.random() * 2 );
        if ( i < 1 || i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else {
    ...
    } else if ( (scoreML == scoreBR) && (scoreML != (score4D || scoreDV || scoreSP || scorePP)) ) {
        let i =  Math.floor(Math.random() * 2 );
        if ( i < 1 || i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else {
    ...
    } else if ( (scoreML == scoreDV) && (scoreML != (score4D || scoreBR || scoreSP || scorePP)) ) {
        let i =  Math.floor(Math.random() * 2 );
        if ( i < 1 || i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/daVinky.html");
        } else {
    ...
    //three ay tie
    else if ( (scoreML == scoreBR) && (scoreML == score4D) && (scoreML != (scoreDV || scoreSP || scorePP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreML == scoreDV) && (scoreML == score4D) && (scoreML != (scoreBR || scoreSP || scorePP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreML == score4D) && (scoreML == scoreSP) && (scoreML != (scoreBR || scoreDV || scorePP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreML == score4D) && (scoreML == scorePP) && (scoreML != (scoreBR || scoreDV || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreML == scoreDV) && (scoreML == scoreBR) && (scoreML != (score4D || scoreSP || scorePP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreML == scoreBR) && (scoreML == scoreSP) && (scoreML != (score4D || scoreDV || scorePP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreML == scoreBR) && (scoreML == scorePP) && (scoreML != (score4D || scoreDV || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreML == scoreDV) && (scoreML == scoreSP) && (scoreML != (score4D || scoreBR || scorePP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/daVinky.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreML == scoreDV) && (scoreML == scorePP) && (scoreML != (score4D || scoreBR || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/daVinky.html");
        } else if ( i == 1 ) {
    ...
    //four way tie
    else if ( (scoreML == scoreBR) && (scoreML == scoreDV) && (scoreML == score4D) && (scoreML != (scoreSP || scorePP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreML == scoreBR) && (scoreML == score4D) && (scoreML == scoreSP) && (scoreML != (scoreDV || scorePP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreML == scoreBR) && (scoreML == score4D) && (scoreML == scorePP) && (scoreML != (scoreDV || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreML == scoreDV) && (scoreML == score4D) && (scoreML == scoreSP) && (scoreML != (scoreBR || scorePP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreML == scoreDV) && (scoreML == score4D) && (scoreML == scorePP) && (scoreML != (scoreBR || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreML == score4D) && (scoreML == scoreSP) && (scoreML == scorePP) && (scoreML != (scoreBR || scoreDV)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreML == scoreDV) && (scoreML == scoreBR) && (scoreML == scoreSP) && (scoreML != (score4D || scorePP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreML == scoreDV) && (scoreML == scoreBR) && (scoreML == scorePP) && (scoreML != (score4D || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreML == scoreBR) && (scoreML == scoreSP) && (scoreML == scorePP) && (scoreML != (score4D || scoreDV)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreML == scoreDV) && (scoreML == scoreSP) && (scoreML == scorePP) && (scoreML != (score4D || scoreBR)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/daVinky.html");
        } else if ( i == 1 ) {
    ...
    //five way tie
    else if ( (scoreML == scoreBR) && (scoreML == scoreDV) && (scoreML == score4D) && (scoreML == scoreSP) && (scoreML != scorePP) ) {
        let i =  Math.floor(Math.random() * 5 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreML == scoreDV) && (scoreML == score4D) && (scoreML == scoreSP) && (scoreML == scorePP) && (scoreML != scoreBR) ) {
        let i =  Math.floor(Math.random() * 5 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreML == scoreDV) && (scoreML == scoreBR) && (scoreML == scoreSP) && (scoreML == scorePP) && (scoreML != score4D) ) {
        let i =  Math.floor(Math.random() * 5 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
...
tiebreakerSP = () => {
    ...
    //four way tie
    else if ( (scoreSP == scoreBR) && (scoreSP == scoreDV) && (scoreSP == score4D) && (scoreSP != (scoreML || scorePP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreSP == scoreBR) && (scoreSP == scoreML) && (scoreSP == score4D) && (scoreSP != (scoreDV || scorePP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreSP == scoreBR) && (scoreSP == score4D) && (scoreSP == scorePP) && (scoreSP != (scoreDV || scoreML)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreSP == scoreDV) && (scoreSP == scoreML) && (scoreSP == score4D) && (scoreSP != (scoreBR || scorePP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreSP == scoreDV) && (scoreSP == score4D) && (scoreSP == scorePP) && (scoreSP != (scoreBR || scoreML)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreSP == scoreML) && (scoreSP == score4D) && (scoreSP == scorePP) && (scoreSP != (scoreBR || scoreDV)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreSP == scoreDV) && (scoreSP == scoreML) && (scoreSP == scoreBR) && (scoreSP != (score4D || scorePP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreSP == scoreDV) && (scoreSP == scoreBR) && (scoreSP == scorePP) && (scoreSP != (score4D || scoreML)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreSP == scoreML) && (scoreSP == scoreBR) && (scoreSP == scorePP) && (scoreSP != (score4D || scoreDV)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scoreSP == scoreML) && (scoreSP == scoreDV) && (scoreSP == scorePP) && (scoreSP != (score4D || scoreBR)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/daVinky.html");
        } else if ( i == 1 ) {
...
tiebreakerPP = () => {
    if ((scorePP == score4D) && (scorePP != (scoreBR || scoreDV || scoreML || scoreSP )) ) {
        let i =  Math.floor(Math.random() * 2 );
        if ( i < 1 || i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else {
    ...
    } else if ( (scorePP == scoreBR) && (scorePP != (score4D || scoreDV || scoreML || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 2 );
        if ( i < 1 || i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else {
    ...
    } else if ( (scorePP == scoreDV) && (scorePP != (score4D || scoreBR || scoreML || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 2 );
        if ( i < 1 || i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/daVinky.html");
        } else {
    ...
    } else if ( (scorePP == scoreML) && (scorePP != (score4D || scoreBR || scoreDV || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 2 );
        if ( i < 1 || i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/maleLead2.html");
        } else {
    ...
    } else if ( (scorePP == scoreSP) && (scorePP != (score4D || scoreBR || scoreDV || scoreML)) ) {
        let i =  Math.floor(Math.random() * 2 );
        if ( i < 1 || i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/sugarParent.html");
        } else {
    ...
    //three way tie
    else if ( (scorePP == scoreBR) && (scorePP == score4D) && (scorePP != (scoreDV || scoreML || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scorePP == scoreDV) && (scorePP == score4D) && (scorePP != (scoreBR || scoreML || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scorePP == scoreML) && (scorePP == score4D) && (scorePP != (scoreBR || scoreDV || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scorePP == scoreSP) && (scorePP == score4D) && (scorePP != (scoreBR || scoreDV || scoreML)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scorePP == scoreDV) && (scorePP == scoreDV) && (scorePP != (score4D || scoreML || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scorePP == scoreML) && (scorePP == scoreBR) && (scorePP != (score4D || scoreDV || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scorePP == scoreSP) && (scorePP == scoreBR) && (scorePP != (score4D || scoreDV || scoreML)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scorePP == scoreML) && (scorePP == scoreDV) && (scorePP != (score4D || scoreBR || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/daVinky.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scorePP == scoreSP) && (scorePP == scoreDV) && (scorePP != (score4D || scoreBR || scoreML)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/daVinky.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scorePP == scoreSP) && (scorePP == scoreML) && (scorePP != (score4D || scoreBR || scoreDV)) ) {
        let i =  Math.floor(Math.random() * 3 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/maleLead2.html");
        } else if ( i == 1 ) {
    ...
    //four way tie
    else if ( (scorePP == scoreBR) && (scorePP == scoreDV) && (scorePP == score4D) && (scorePP != (scoreML || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scorePP == scoreBR) && (scorePP == scoreML) && (scorePP == score4D) && (scorePP != (scoreDV || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scorePP == scoreBR) && (scorePP == scoreSP) && (scorePP == score4D) && (scorePP != (scoreDV || scoreML)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scorePP == scoreDV) && (scorePP == scoreML) && (scorePP == score4D) && (scorePP != (scoreBR || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scorePP == scoreDV) && (scorePP == scoreSP) && (scorePP == score4D) && (scorePP != (scoreBR || scoreML)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scorePP == scoreML) && (scorePP == scoreSP) && (scorePP == score4D) && (scorePP != (scoreBR || scoreDV)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scorePP == scoreDV) && (scorePP == scoreML) && (scorePP == scoreBR) && (scorePP != (score4D || scoreSP)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scorePP == scoreDV) && (scorePP == scoreSP) && (scorePP == scoreBR) && (scorePP != (score4D || scoreML)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scorePP == scoreML) && (scorePP == scoreSP) && (scorePP == scoreBR) && (scorePP != (score4D || scoreDV)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scorePP == scoreML) && (scorePP == scoreSP) && (scorePP == scoreDV) && (scorePP != (score4D || scoreBR)) ) {
        let i =  Math.floor(Math.random() * 4 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/daVinky.html");
        } else if ( i == 1 ) {
    ...
    //five way tie
    else if ( (scorePP == scoreBR) && (scorePP == scoreDV) && (scorePP == scoreML) && (scorePP == score4D) && (score4D != scoreSP) ) {
        let i =  Math.floor(Math.random() * 5 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scorePP == scoreBR) && (scorePP == scoreDV) && (scorePP == scoreSP) && (scorePP == score4D) && (score4D != scoreML) ) {
        let i =  Math.floor(Math.random() * 5 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scorePP == scoreBR) && (scorePP == scoreML) && (scorePP == scoreSP) && (scorePP == score4D) && (scorePP != scoreDV) ) {
        let i =  Math.floor(Math.random() * 5 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scorePP == scoreDV) && (scorePP == scoreML) && (scorePP == scoreSP) && (scorePP == score4D) && (scorePP != scoreBR) ) {
        let i =  Math.floor(Math.random() * 5 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        } else if ( i == 1 ) {
    ...
    } else if ( (scorePP == scoreDV) && (scorePP == scoreML) && (scorePP == scoreSP) && (scorePP == scoreBR) && (scorePP != score4D) ) {
        let i =  Math.floor(Math.random() * 5 );
        if ( i == 0 ) {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        } else if ( i == 1 ) {
...
getResult = () => {
    ...
    if ((score4D >= scoreBR) && (score4D >= scoreDV) && (score4D >= scoreML) && (score4D >= scoreSP) && (score4D >= scorePP)) {
        if ( score4D == (scoreBR || scoreDV || scoreML || scoreSP || scorePP) ) {
            tiebreaker4D(score4D, scoreBR, scoreDV, scoreML, scoreSP, scorePP);
        } else {
            return window.location.assign("/ELSAPersonalityQuiz/4DChessmaster.html");
        };
        ...
        if ( scoreBR == (score4D || scoreDV || scoreML || scoreSP || scorePP) ) {
            tiebreakerBR(score4D, scoreBR, scoreDV, scoreML, scoreSP, scorePP);
        } else {
            return window.location.assign("/ELSAPersonalityQuiz/biggestRizzler.html");
        };
        ...
        if ( scoreDV == (score4D || scoreBR || scoreML || scoreSP || scorePP) ) {
            tiebreakerDV(score4D, scoreBR, scoreDV, scoreML, scoreSP, scorePP);
        } else {
            return window.location.assign("/ELSAPersonalityQuiz/daVinky.html");
        };
        ...
        if ( scoreML == (score4D || scoreBR || scoreDV || scoreSP || scorePP) ) {
            tiebreakerML(score4D, scoreBR, scoreDV, scoreML, scoreSP, scorePP);
        } else {
            return window.location.assign("/ELSAPersonalityQuiz/maleLead2.html");
        };
        ...
        if ( scoreSP == (score4D || scoreBR || scoreDV || scoreML || scorePP) ) {
            tiebreakerSP(score4D, scoreBR, scoreDV, scoreML, scoreSP, scorePP);
        } else {
            return window.location.assign("/ELSAPersonalityQuiz/sugarParent.html");
        };
        ...
        if ( scorePP == (score4D || scoreBR || scoreDV || scoreML || scoreSP) ) {
            tiebreakerPP(score4D, scoreBR, scoreDV, scoreML, scoreSP, scorePP);
        } else {
        return window.location.assign("/ELSAPersonalityQuiz/tacticalPplPleaser.html");
        };
    } else {
